...
public class CheckoutScreen {
    ...
    /**
     *
     * @param FullName  value from src/test/resources/testData/checkoutTestData.json
     * @param AddressLine value from src/test/resources/testData/checkoutTestData.json
     * @param AddressLine2 value from src/test/resources/testData/checkoutTestData.json
     * @param City value from src/test/resources/testData/checkoutTestData.json
     * @param State value from src/test/resources/testData/checkoutTestData.json
     * @param ZipCode value from src/test/resources/testData/checkoutTestData.json
     * @param Country value from src/test/resources/testData/checkoutTestData.json
     * @return new Payment Screen
     */
    @Step("fill Checkout Information ==> Full Name: [{FullName}], Address Line: [{AddressLine}],Address Line2: [{AddressLine2}], City: [{City}],State: [{State}], ZipCode: [{ZipCode}],Country: [{Country}]")
